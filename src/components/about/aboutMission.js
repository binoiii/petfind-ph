    ...
    <div className="mb-16 md:mb-0 flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-6/12 flex bg-gray-100 rounded-lg order-2 md:order-1">
        <p className="p-8 md:p-12 self-center font-primary text-gray-700 text-justify leading-loose">
          ...
          pet tags with all necessary information uploaded and accessible to our{" "}
          <span className="font-semibold">Pet Profile Database</span> making it
          easier to find lost pets. It is our company’s mission to provide
          comfort and relief for both pet and owners.
        </p>
      </div>
    </div>
  )
